...
Version 2+ of this plugin is compatible with Ionic 5+ and Capacitor 3. If your project uses Capacitor 2, please make sure you install [version 1](https://github.com/huynhtheviet/capacitor-plugin-camera-preview/releases/tag/v1.2.1) of this plugin.
...
**Important** `camera-preview` 3+ requires Gradle 7. If you are using Gradle 4, please use [version 2](https://github.com/huynhtheviet/capacitor-plugin-camera-preview/tree/v2.1.0) of this plugin.
...
A working example can be found at [Demo](https://github.com/huynhtheviet/capacitor-plugin-camera-preview/tree/master/demo)
